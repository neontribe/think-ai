...
const RouteButton = ({ href, children, className = "", ariaLabel, onClick, variant ="primary", type= "button", ...props }) => {
    const routeStyle = {
        ...
        third:  "bg-[#63E2F1] text-[#1B0080] px-8 py-3 w-[300px] h-[48px] text-lg inline-flex items-center justify-center rounded-full transition duration-300 hover:bg-[#9747FF] hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#9747FF]",
    }
