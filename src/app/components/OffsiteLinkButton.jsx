...
const OffsiteLinkButton = ({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center justify-center rounded-full font-bold transition duration-300 hover:bg-[#9747FF] hover:text-white focus:ring-2 focus:ring-[#9747FF] focus:ring-offset-2 focus:outline-none ${buttonStyles[variant]} ${className}`}
