        ...
        <header role="banner" className="w-full bg-[#1C0080] text-white py-4 px-6 flex justify-between items-center">
            ...
            {!hidelinks && (
                <nav className="flex md:flex-row flex-col gap-2 md:gap-8 items-end" aria-label="Main navigation">
                    <Link href="/our-team" className="text-[16px] hover:text-[#87E2D9] underline mb-2 md:mb-0 focus:outline-none focus:ring rounded-md" aria-label="View our team">our team</Link>  
                    <Link href="/group-leaders" className="w-full md:w-auto focus:outline-none focus:ring-2 focus:ring" aria-label="resources for group leaders"> 
